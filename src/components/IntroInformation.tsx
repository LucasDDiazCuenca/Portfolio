const IntroInformation = (): React.ReactElement => {
	return (
		<article className="w-full mt-10 xl:my-60 px-8 sm:px-36 relative z-10 text-center sm:text-left text-xl pointer-events-none">
			<div className="pointer-events-none md:px-32">
				<p className="py-3">
